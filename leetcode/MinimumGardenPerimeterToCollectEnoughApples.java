 ...
 * Created at : 19/08/21
 * <p>
 * <a href=https://leetcode.com/contest/weekly-contest-252/problems/minimum-garden-perimeter-to-collect-enough-apples/>5187. Minimum Garden Perimeter to Collect Enough Apples</a>
 *
...
public class MinimumGardenPerimeterToCollectEnoughApples {
    public static void main(String[] args) {
        long n = 13;
        System.out.println(new MinimumGardenPerimeterToCollectEnoughApples().minimumPerimeter(n));
    }
